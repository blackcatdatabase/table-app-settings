...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII: 2 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\app-settings](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\app-settings)
...
graph LR
  ...
  app_settings["app_settings"]:::center
  app_settings -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package app-settings -Apply
