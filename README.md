...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 2 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\app-settings](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\app-settings) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package app-settings -Apply
