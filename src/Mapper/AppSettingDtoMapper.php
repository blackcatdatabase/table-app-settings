...
namespace BlackCat\Database\Packages\AppSettings\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO AppSettingDto:
...
final class AppSettingDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'version', 'updated_by' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): AppSettingDto
    {
        /** @var AppSettingDto */
    ...
    public static function fromRowOrNull(?array $row): ?AppSettingDto
    {
     ...
     */
    public static function toRow(AppSettingDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(AppSettingDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(AppSettingDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,AppSettingDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,AppSettingDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(AppSettingDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,AppSettingDto>
     */
