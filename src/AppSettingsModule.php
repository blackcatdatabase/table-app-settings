...
final class AppSettingsModule implements ModuleInterface
{
    public function name(): string { return 'table-app_settings'; }
    public function table(): string { return 'app_settings'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedFk  = [ 'fk_app_settings_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [],
            'foreignKeys' => [ 'fk_app_settings_user' ],
        ];
    }
}
