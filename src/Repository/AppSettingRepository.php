...
final class AppSettingRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`app_settings`' : '"app_settings"';
     ...
     * [ 'setting_key' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'setting_value', 'type', 'section', 'description', 'is_protected', 'updated_at', 'updated_by' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'setting_key' ];
        $upd  = [ 'setting_value', 'type', 'section', 'description', 'is_protected', 'updated_at', 'updated_by' ];
