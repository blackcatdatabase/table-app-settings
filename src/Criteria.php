 ...
 * - whitelist filtrů: [ 'setting_key', 'setting_value', 'type', 'section', 'description', 'is_protected', 'updated_at', 'version', 'updated_by' ]
 * - whitelist LIKE:   [ 'setting_key', 'setting_value', 'type', 'section', 'description' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'setting_key', 'setting_value', 'type', 'section', 'description', 'is_protected', 'updated_at', 'version', 'updated_by' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'setting_key', 'setting_value', 'type', 'section', 'description', 'is_protected', 'updated_at', 'version', 'updated_by' ], true);
            $parts = [];
