...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'setting_key', 'setting_value', 'type', 'section', 'description', 'is_protected', 'updated_at', 'updated_by' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'setting_key', 'setting_value', 'type', 'section', 'description', 'is_protected', 'updated_at', 'updated_by' ], true);
            $parts = [];
